"""Configuration and constants for Kiku.

Loads user overrides from ~/.kiku/config.toml, falls back to hardcoded defaults.
"""
...
def _resolve_music_roots() -> list[Path]:
    ...
    env_roots = os.environ.get("KIKU_MUSIC_ROOTS")
    if env_roots:
