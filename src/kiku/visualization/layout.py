                ...
                [
                    ...
                    html.Div(
                        [
                            ...
                            html.Div(
                                id="cue-click-info",
                                style={"color": "#8892b0", "fontSize": "0.85rem", "padding": "6px"},
                            ),
                        ],
                        style={
                            "display": "flex",
                ...
                children=[
                    html.Div(
                        [
                            ...
                            dcc.Dropdown(
                                id="compare-track-selector",
                                placeholder="Select track to compare...",
        ...
        [
            ...
            html.Div(
                [
                    ...
                    html.Div(
                        id="track-nudge-panel",
                        style={"display": "none"},
                        children=[
                            html.Div(
                                [
                                    html.Span(
                                        id="nudge-track-label",
                                        style={
                                            "color": "#e0e0e0",
                                            "fontWeight": "600",
                                            "marginRight": "12px",
            ...
            html.Div(
                [
                    ...
                    html.Div(
                        [
                            html.Button(
                                "< Prev", id="btn-prev-transition", className="btn btn-secondary"
                            ),
                            html.Span(
                                id="transition-label",
                                style={"padding": "0 16px", "color": "#e0e0e0"},
                            ),
                            html.Button(
                                "Next >", id="btn-next-transition", className="btn btn-secondary"
                            ),
                        ],
                                ...
                                [
                                    html.Div(
                                        [
                                            ...
                                            html.Span(
                                                id="player-a-label", style={"color": "#e0e0e0"}
                                            ),
                                        ],
                                        style={"marginBottom": "4px"},
                                    ),
                                    html.Audio(
                                        id="audio-player-a", controls=True, style={"width": "100%"}
                                    ),
                                ],
                                style={"flex": 1},
                            ),
                                ...
                                [
                                    html.Div(
                                        [
                                            ...
                                            html.Span(
                                                id="player-b-label", style={"color": "#e0e0e0"}
                                            ),
                                        ],
                                        style={"marginBottom": "4px"},
                                    ),
                                    html.Audio(
                                        id="audio-player-b", controls=True, style={"width": "100%"}
                                    ),
                                ],
                                style={"flex": 1},
                            ),
                    ...
                    html.Div(
                        [
                            ...
                            html.Button(
                                "-8 beats",
                                id="btn-trans-nudge-left-big",
                                className="btn btn-secondary",
                                style={"fontSize": "0.8rem", "padding": "4px 8px"},
                            ),
                            html.Button(
                                "-1 beat",
                                id="btn-trans-nudge-left",
                                className="btn btn-secondary",
                                style={
                                    "fontSize": "0.8rem",
                                    "padding": "4px 8px",
                            ...
                            html.Button(
                                "+1 beat",
                                id="btn-trans-nudge-right",
                                className="btn btn-secondary",
                                style={"fontSize": "0.8rem", "padding": "4px 8px"},
                            ),
                            html.Button(
                                "+8 beats",
                                id="btn-trans-nudge-right-big",
                                className="btn btn-secondary",
                                style={
                                    "fontSize": "0.8rem",
                                    "padding": "4px 8px",
