...
from kiku.config import VISUALIZER_PORT
from kiku.db.models import Track, get_session
from kiku.visualization.callbacks import register_callbacks
from kiku.visualization.layout import build_main_layout
...
def create_app(debug: bool = False) -> Dash:
    ...
    app = Dash(
        ...
        title="Kiku — Waveform Visualizer",
